...
pub fn transfer_operatorship(
    ...
    let (transferer_roles_pda, _) =
        role_management::find_user_roles_pda(&crate::id(), &token_manager_pda, &transferer);

    let accounts = vec![
        AccountMeta::new_readonly(its_root_pda, false),
        AccountMeta::new_readonly(solana_program::system_program::id(), false),
        AccountMeta::new(payer, true),
        AccountMeta::new(transferer, true),
        AccountMeta::new(transferer_roles_pda, false),
        AccountMeta::new_readonly(token_manager_pda, false),
...
pub fn accept_operatorship(
    ...
    let (proposal_pda, _) =
        role_management::find_roles_proposal_pda(&crate::id(), &token_manager_pda, &from, &accepter);
