...
async fn test_outgoing_interchain_transfer_within_limit(
    ...
    let emitted_event = find_event_in_inner_instructions::<CallContractEvent>(&inner_ixs)
...
async fn test_flow_slot_initialization_outgoing_transfer(
    ...
    let emitted_event_2 = find_event_in_inner_instructions::<CallContractEvent>(&inner_ixs_2)
        .ok_or_else(|| anyhow!("CallContractEvent not found"))?;
