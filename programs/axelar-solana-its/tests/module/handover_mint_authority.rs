...
use crate::{find_event_in_inner_instructions, BorshPdaAccount, ItsTestContext};
...
async fn test_handover_mint_authority_exploit_prevention(ctx: &mut ItsTestContext) {
    ...
    let inner_ixs = simulation_result
        ...
        .cloned()
        .unwrap();
    let target_token_id_event = find_event_in_inner_instructions::<
    ...
    let inner_ixs = simulation_result
        ...
        .cloned()
        .unwrap();
    let bob_token_id_event = find_event_in_inner_instructions::<
        axelar_solana_its::events::InterchainTokenIdClaimed,
    >(&inner_ixs)
    .ok_or_else(|| anyhow!("InterchainTokenIdClaimed not found"))
    .unwrap();
...
async fn test_successful_handover_mint_authority(ctx: &mut ItsTestContext) {
    ...
    let inner_ixs = simulation_result
        ...
        .cloned()
        .unwrap();
    let alice_token_id_event = find_event_in_inner_instructions::<
        axelar_solana_its::events::InterchainTokenIdClaimed,
    >(&inner_ixs)
    .ok_or_else(|| anyhow!("InterchainTokenIdClaimed not found"))
    .unwrap();
...
async fn test_fail_handover_mint_authority_for_lock_unlock_token(ctx: &mut ItsTestContext) {
    ...
    let inner_ixs = simulation_result
        ...
        .cloned()
        .unwrap();
    let token_id_event = find_event_in_inner_instructions::<
        axelar_solana_its::events::InterchainTokenIdClaimed,
    >(&inner_ixs)
    .ok_or_else(|| anyhow!("InterchainTokenIdClaimed not found"))
    .unwrap();
